...
export class VanzareApp extends LitElement {
  static get styles() {
    return css`
      :host {
  ...
  constructor() {
    ...
    this.incasareList = read("incasareList");
  ...
  render() {
    ...
    this.indexTabelIncasare = 1;
    return html`
      <div id="myModalDenumire" class="modal">
        <!-- Modal content -->
      ...
      <div class="row">
        <div class="column left">
          ...
          <fieldset>
            <legend>Bon fiscal nr. 23</legend>
            <div class="tableFixHead">
              <table>
                <thead>
                  <th>Nr. crt.</th>
                ...
                <tbody>
                  ${read("intrareBonFiscalList")
                    .reverse()
                    .map(
                      (dataRow) => html`<tr
                        class=${dataRow.cancelled == true
                          ? "cancelledItem"
                          : ""}
                      >
                        ...
                        <td>
                          <button
                            ...
                            id=${read("intrareBonFiscalList").length -
                            this.indexTabel +
                            1}
                            type="button"
                          ></button>
          ...
          <button @click=${this._onAnuleazaClick} class="anuleazaButton">
            Anuleaza
          </button>
          <button @click=${this._onInAsteptareClick} class="inAsteptareButton">
            In asteptare
          </button>
          <button @click=${this._onSubtotalClick} 
          class=${
            read("subtotalClicked") == true
        ...
        <div class="column right">
          <fieldset>
            <legend>Generare rapoarte</legend>
            <button @click=${this._onRaportXClick}>Raport X</button>
            <button @click=${this._onRaportZClick}>Raport Z</button>
          </fieldset>
          <fieldset>
            <legend>Taste rapide</legend>
            <div class="row">
              <div class="columnTaste">
                <button id="TR1" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[0].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button class="tasteRapide" id="TR2" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[1].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button class="tasteRapide" id="TR3" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[2].denumire}
                </button>
                <br />
              </div>
            </div>
            <div class="row">
              <div class="columnTaste">
                <button id="TR4" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[3].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR5" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[4].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR6" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[5].denumire}
                </button>
                <br />
              </div>
            </div>
            <div class="row">
              <div class="columnTaste">
                <button id="TR7" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[6].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR8" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[7].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR9" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[8].denumire}
                </button>
                <br />
              </div>
            </div>
            <div class="row">
              <div class="columnTaste">
                <button id="TR10" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[9].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR11" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[10].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR12" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[11].denumire}
                </button>
                <br />
              </div>
            </div>
            <div class="row">
              <div class="columnTaste">
                <button id="TR13" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[12].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR14" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[13].denumire}
                </button>
              </div>
              <div class="columnTaste">
                <button id="TR15" class="tasteRapide" @click=${
                  this._onTastaRapidaClick
                }>
                  ${this.tasteRapide[14].denumire}
                </button>
                <br />
              </div>
            </div>
  ...
  _getDiscountIncrease() {
    ...
    if (read("discountPercentage") != 0) {
      discountIncreaseValue =
        ((this._getTotalBeforeDiscountIncrease() * read("discountPercentage")) /
          100) *
        -1;
    }
    if (read("discountValue") != 0) {
      discountIncreaseValue = read("discountValue") * -1;
    }
    if (read("increasePercentage") != 0) {
      discountIncreaseValue =
        (this._getTotalBeforeDiscountIncrease() * read("increasePercentage")) /
        100;
    }
    if (read("increaseValue") != 0) {
      discountIncreaseValue = read("increaseValue");
    }
  ...
  _getTotalPlatit() {
    var totalPlatit = 0;
    read("incasareList").forEach((line) => {
  ...
  _addIntrareToBonFiscalIfProdusGasitIsNotNull() {
    if (this.denumireProdusGasit != "" && this.denumireProdusGasit != null) {
      ...
      if (this.intrareBonFiscalList != null) {
        this.intrareBonFiscalList = read("intrareBonFiscalList");
      } else {
        this.intrareBonFiscalList = [];
      }

      this.intrareBonFiscalList.push(intrareBonFiscalRequestDTO);
      write(this.intrareBonFiscalList, "intrareBonFiscalList");
  ...
  _onStergeIncasareClick(event) {
    ...
    const removed = this.incasareList.splice(parseInt(indexLocal), 1);

    write(this.incasareList, "incasareList");
    this.incasareList = read("incasareList");
  }

  _onRaportXClick(event) {
    event.preventDefault();

    const commandRequestDTO = this._buildCommandRequestDTO(
      this._getConstantaByDenumire("caleFisierBonFiscal").valoareText,
      "RAPORT_X"
    );

    postData("http://localhost:8080/command", commandRequestDTO).then(
      (data) => {
  ...
  _onListareClick(event) {
    ...
    const bonFiscalRequestDTO = {
      ...
      incasareList: read("incasareList"),
      intrareBonFiscalList: read("intrareBonFiscalList"),
      fiscal: true,
      cancelled: false,
      text: "",
      discountPercentage: read("discountPercentage"),
      discountValue: read("discountValue"),
      increasePercentage: read("increasePercentage"),
      increaseValue: read("increaseValue"),
      status: "LISTAT",
    };
  ...
  _getConstantaByDenumire(denumire) {
    var constanta = {};
    read("constante").forEach((element) => {
      if (element.denumire == denumire) {
        constanta = element;
      }
    });
    return constanta;
  ...
  _buildCommandRequestDTO(path, commandType) {
    const commandRequestDTO = {
      path: path,
  ...
  _checkIfStorageValuesExistAndInitilizareIfNot() {
    ...
    if (read("intrareBonFiscalList") == null) {
      write([], "intrareBonFiscalList");
    }
  ...
  _instrareBonFiscalListIsEmpty() {
    return read("intrareBonFiscalList").length == 0;
  }
}

window.customElements.define("vanzare-app", VanzareApp);
